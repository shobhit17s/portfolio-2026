...
,
  ...
  /* ====================================================================
     ...
     TO ADD A DRAWING, SAVE IT AS ITS SLOT'S NAME. Nothing here has to be
     edited:

         the empty box on the page says   img-06-product-strategy
         you save                         assets/img-06-product-strategy.png
         that is all

     PNG or JPG. The page finds it, and asks the drawing itself how wide and
     how tall it is, so there is no shape to measure and type in either. The
     notes below are only what the empty box SAYS while it waits - and, once
     a drawing arrives, what a screen reader is told it shows.

     A slot with no drawing yet quietly looks for one and does not find it,
     and the browser notes that in its console. Those are the page looking,
     not the page breaking.

     To check your own work, open the console on this page and type
         CS.PrototypeEmbed.empty()
     and it will list every slot still waiting, with the exact filename each
     one wants.

     THE SECOND HALF OF THIS FILE IS DIFFERENT. Those entries name a file by
     hand, and a named file always wins over a found one. That is where the
     drawings that arrived before this existed live, along with the running
     prototype - and it is what you write if a drawing has to keep a
     different filename, or wants `fit: 'cover'` (fill the space and trim the
     edges, which suits a screenshot but never a diagram).
     ==================================================================== */
  media: {

    /* ---------------------------------------------------------------- */
    /*  WAITING FOR A DRAWING - just save the file, named as the slot    */
    /* ---------------------------------------------------------------- */
    ...
    /* slide 14 - the exploratory carousel */
    'img-14-wireframe-1':
      { note: 'Exploratory wireframe \u2014 first option.' },
    'img-14-wireframe-2':
      { note: 'Exploratory wireframe \u2014 second option.' },
    'img-14-wireframe-3':
      { note: 'Exploratory wireframe \u2014 third option.' },
    'img-14-wireframe-4':
      { note: 'Exploratory wireframe \u2014 fourth option.' },

    /* slide 17 */
    'img-17-balancing-tensions':
      { note: 'The forces pulling against each other: user needs, tech, product requirements, design system.' },

    /* slide 19 - four tabs, two diagrams in each */
    'img-19-material-moves-1':
      { note: 'Identification of material moves \u2014 first step.' },
    'img-19-material-moves-2':
      { note: 'Identification of material moves \u2014 second step.' },
    'img-19-sub-industry-1':
      { note: 'Sub-industry-level analysis of KIMs \u2014 first step.' },
    'img-19-sub-industry-2':
      { note: 'Sub-industry-level analysis of KIMs \u2014 second step.' },
    'img-19-trend-1':
      { note: 'Trend analysis \u2014 first step.' },
    'img-19-trend-2':
      { note: 'Trend analysis \u2014 second step.' },
    'img-19-kim-level-1':
      { note: 'KIM-level analysis \u2014 first step.' },
    'img-19-kim-level-2':
      { note: 'KIM-level analysis \u2014 second step.' },

    /* slide 21, and the way back at the end */
    ...
    /* the nutshell view */
    'img-logo-mark':
      { note: 'The product mark.' },
    'img-strip-industry-map':
      { note: 'One wide view of the whole industry landscape.' },
    'img-20-client-integration':
      { note: 'Where the industry insights surface inside the client dashboard.' },
    'img-wf-monitor-1':
      { note: 'The KIDs page as it opens: drivers grouped by the direction of their impact.' },
    'img-wf-monitor-2':
      { note: 'A single driver expanded, with its trend and the reasoning behind it.' },
    'img-wf-monitor-3':
      { note: 'Filtering the drivers down to the ones that moved this quarter.' },
    'img-wf-client-1':
      { note: 'The existing client dashboard, with the new industry panel added.' },
    'img-wf-client-2':
      { note: 'Following an industry driver through to the client it affects.' },
    'img-wf-industry-1':
      { note: 'The wider industry dashboard: ratings, market information, news, themes.' },
    'img-wf-industry-2':
      { note: 'A SWOT assessment sitting alongside the drivers.' },
    'img-ia-structure':
    ...
    /* the two drawers */
    'img-drawer-questions':
      { note: 'The synthesis wall, or the page of the workbook where these were worked through.' },
    'img-drawer-scope':
      { note: 'The four-step diagram of how the brief grew.' },

    /* ---------------------------------------------------------------- */
    /*  NAMED BY HAND - a named file always beats a found one            */
    /* ---------------------------------------------------------------- */
