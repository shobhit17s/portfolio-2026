  ...
  HW.WORLDS = [
    {
      ...
      props: [
        ...
        { src: 'props/home-rammed-earth.png',        lat: 26,  lon: 0,   size: 0.698 },
        { src: 'props/home-rammed-earth.png',        lat: -30, lon: 309, size: 0.51 },
        { src: 'props/home-snow-leopard.png',  lat: 8,   lon: 258, size: 0.39 },
        /* STONES. The same drawing on every world, more than once each -
           the one thing the four planets have in common, so they read as
           four places in the same universe rather than four unrelated balls.
           Wide and low, so the heights are small: at 0.30 tall it is 0.72
           across. */
        { src: 'props/stones.png', lat: 4,   lon: 88,  size: 0.225 },
        { src: 'props/stones.png', lat: -24, lon: 232, size: 0.165 }
      ],
    ...
    },
    {
      ...
      props: [
        ...
        { src: 'props/stones.png', lat: 14,  lon: 190, size: 0.21 },
        { src: 'props/stones.png', lat: -26, lon: 84,  size: 0.158 }
      ],
      food: [
        { src: 'food/pbj-sandwich.png', lat: 8,   lon: 128, size: 0.374 },   // 0.44 wide
        { src: 'food/protein-bar.png',  lat: -14, lon: 282, size: 0.255 }   // 0.58 wide
      ]
    },
    {
      id: 'play',
      ...
      props: [
        ...
        { src: 'props/stones.png', lat: -8,  lon: 108, size: 0.203 },
        { src: 'props/stones.png', lat: 34,  lon: 320, size: 0.15 }
      ],
      food: [
    ...
    },
    {
      ...
      props: [
        ...
        { src: 'props/stones.png', lat: 16,  lon: 120, size: 0.225 },
        { src: 'props/stones.png', lat: -28, lon: 310, size: 0.165 }
      ],
      food: [
