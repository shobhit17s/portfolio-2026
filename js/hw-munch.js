  ...
  HW.createMunch = function () {
    ...
    return {
      ...
      /* A handwritten nudge next to the first snack, until one gets eaten.
         ...
         Not on a phone. The note is written to the RIGHT of the snack, and
         on a narrow screen the snack is often already near the right edge -
         so the words ran off the side and the page looked broken. It is a
         nicety, not an instruction; a phone is better off without it. */
