...
const NOTE = {
  ...
  'home-rammed-earth': 'replaces the little hut.',
  'home-snow-leopard': 'the only living thing out here apart from him.',
  'stones': 'GROUND CLUTTER, on all four worlds, twice on each. Wide and low, so it is small — do not fill the box.',
